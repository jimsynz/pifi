defmodule PiFi.Peripheral.BatteryTest do
  ...
  doctest PiFi.Peripheral.Battery, import: true
  ...
  setup do
    ...
    # This test starts no `PiFi.AutoStandby`, so nothing acts on that and the player is
    # left where it was. See `PiFi.Application.listening_children/0`.
  ...
  describe "the point where a person must charge the cell" do
    ...
    # copies that drift. See `PiFi.Event.Device.BatteryChanged`.
    #

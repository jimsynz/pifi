defmodule PiFi.Peripheral.ButtonsTest do
  ...
  describe "open/1" do
    test "a line that another part of the system holds gives no button of its own" do
      # `PiFi.Test.RecordingScreen` opens every line, so this names one line and
  ...
  # release and not at the press. See `PiFi.Peripheral.Buttons`.

defmodule PiFi.Player.FileSourceTest do
  use ExUnit.Case, async: true

  alias PiFi.Player.FileSource
  alias PiFi.Player.FileSource.State
  ...
  describe "where a resume begins" do
    ...
    # AAC holds frames of another shape, so `PiFi.Player.Mp3Frame` must not read it.
  ...
  describe "a skip" do
    ...
    # from where it started. See `PiFiWeb.Telemetry`.

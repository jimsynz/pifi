defmodule PiFi.Cache.TouchesTest do
  @moduledoc """
  The used marks of the cache, held in memory and written together.

  `PiFi.Application` starts no buffer in the test environment, because the sandbox
  ...
  setup do
    ...
    # writes is of the last second. See `PiFi.Cache.used/1`.
    Application.put_env(:pifi, :cache_touch_after_seconds, 0)

    on_exit(fn ->
      Application.delete_env(:pifi, :cache_touch_after_seconds)

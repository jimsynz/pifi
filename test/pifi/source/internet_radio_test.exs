defmodule PiFi.Source.InternetRadioTest do
  ...
  # `PiFi.Radio.Fill` writes a station into the catalogue, and this source reads it
  ...
  describe "what this source holds" do
    ...
    # to `PiFi.Playback.Queue` and not to a source.
  ...
  # text of the person is not needed. `PiFiWeb.SearchLive` matches the text.
  ...
  describe "resolve/1" do
    ...
    # `PiFi.Radio.CarryFavourites` writes a station that holds the mark of a person
  ...
  # `PiFiWeb.BrowseLive` for the page that walks them.

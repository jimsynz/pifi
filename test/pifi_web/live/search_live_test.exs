defmodule PiFiWeb.SearchLiveTest do
  ...
  describe "finding a station" do
    ...
    # `PiFiWeb.ItemList` holds the subscription and the read, so this page names
  ...
  # for a source that holds more than one kind. See `c:PiFi.Source.kinds/0`.

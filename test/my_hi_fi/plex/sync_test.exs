defmodule MyHiFi.Plex.SyncTest do
  ...
  describe "sync_library" do
    ...
    # a playlist and not a file. `caches_audio?` of `MyHiFi.Playback.Item` and
    # `MyHiFi.Player.skippable?/1` both name `transport == :download`, so the column is

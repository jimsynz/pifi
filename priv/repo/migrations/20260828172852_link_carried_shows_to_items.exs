defmodule PiFi.Repo.Migrations.LinkCarriedShowsToItems do
  @moduledoc """
  Join each show to its item, for the shows that `PiFi.Podcast.CarryPlaces` carried.
  ...
  key: `PiFi.Podcast.Show.subscriptions` finds a subscription through it, and
  `PiFi.Source.Podcasts` finds the feed behind a container through it. A show with no
  ...
  A show and its item meet at the address of the feed, because `PiFi.Podcast.Fill`

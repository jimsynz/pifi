defmodule PiFi.Podcast do
  ...
  This domain stores no episode and no title. `PiFi.Playback.Item` keeps every
  playable thing of this firmware, and `PiFi.Podcast.Fill` writes the shows and the

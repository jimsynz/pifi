defmodule PiFi.Podcast.Fill do
  @moduledoc """
  Write a show and its episodes into the catalogue.

  A show becomes a `PiFi.Playback.Item` of the kind `:container`, and each episode
  ...
  columns. The category of a show is a facet, and `PiFi.Podcast.Index` gives it.

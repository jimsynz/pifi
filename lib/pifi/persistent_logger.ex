defmodule PiFi.PersistentLogger do
  @moduledoc """
  ...
  This handler therefore also writes each line to `/root/pifi.log`, and it cuts
  ...
  The file goes to `/root/pifi.log.1` when it reaches its limit, and the old

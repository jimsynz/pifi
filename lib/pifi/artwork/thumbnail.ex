defmodule PiFi.Artwork.Thumbnail do
  @moduledoc """
  ...
  **`>` in the size makes it shrink a picture and never grow one.** A size of `320x`
  ...
  32 pixels, and `PiFi.Artwork.Accent` reads it.
  ...
  **The grid is a PPM file and not a raw one.** A PPM carries a header that says how
  ...
  Each thumbnail row carries this, and `PiFi.Artwork.generate_thumbnail/1` compares
  ...
  **It reads the code of this module and of `PiFi.Artwork.Accent`, and not their

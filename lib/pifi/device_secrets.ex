defmodule PiFi.DeviceSecrets do
  @moduledoc """
  ...
  keeps each value on the application data partition. `PiFi.Application` calls
  ...
  The session cookie salt in `PiFiWeb.Endpoint` stays as it is. That one is a
  ...
  def put(data_dir \\ @data_dir) do
    ...
    |> then(&Application.put_env(:pifi, PiFiWeb.Endpoint, &1))
  end

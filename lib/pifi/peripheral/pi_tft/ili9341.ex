defmodule PiFi.Peripheral.PiTft.Ili9341 do
  @moduledoc """
  ...
  `PiFi.Screen.Renderer` gives, and it keeps the top bits of each channel.
  ...
  `PiFi.Peripheral.PiTft` does this for standby, because a screen that stayed lit
  ...
  **The backlight is not part of this, and the order is the reason.** A caller wakes
  ...
  light is on the touch controller. See `PiFi.Peripheral.PiTft.Stmpe610`.
  """
  ...
  `PiFi.Screen.Renderer` gives four bytes for each pixel, and this keeps

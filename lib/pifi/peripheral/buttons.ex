defmodule PiFi.Peripheral.Buttons do
  @moduledoc """
  ...
  **Two boards use this, and each one names its own lines.** The PiTFT has four in a
  ...
  the press means: `PiFi.DeviceUi` decides that, because a row of four and a pad of two
  ...
  **Read the order of a row one button at a time**: a person who presses four buttons in
  ...
  `PiFi.Event.Input.ButtonPressed` named the line each time. **On the PiTFT, line 18 is
  ...
  could not be read. See `PiFi.Peripheral.PiTft.Stmpe610`.

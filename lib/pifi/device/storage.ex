defmodule PiFi.Device.Storage do
  @moduledoc """
  ...
  settle of `PiFi.Device.Monitor` and `usage` reads the cache and the items, which
  ...
  actions do
    ...
    action :report, :map do
      ...
      run PiFi.Device.Storage.Report
    end

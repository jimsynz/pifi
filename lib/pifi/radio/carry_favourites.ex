defmodule PiFi.Radio.CarryFavourites do
  @moduledoc """
  Keep the stations that a person marked, when the catalogue takes over from `Station`.

  `PiFi.Source.InternetRadio` reads `PiFi.Playback.Item` now, and a device rebuilds
  ...
  `PiFi.Radio.Fill` uses: the name of the source, and the identifier of the station

defmodule PiFi.Plex.Sync do
  ...
  settings page name. `PiFi.Jellyfin.Sync` is a resource of the same shape, and
  `PiFi.Radio.Sync` says why each control is an action.
  """
  ...
  oban do
    scheduled_actions do
      ...
      # by hand, and `PiFi.AutoSync` runs it when the network answers.
      #
      ...
      schedule :sync_library, "0 4 * * *" do
        action :sync_library
        worker_module_name PiFi.Plex.Sync.Workers.Library
        queue :default
        max_attempts 3
      end
      ...
      schedule :cache_favourites, "40 * * * *" do
        ...
        worker_module_name PiFi.Plex.Sync.Workers.Favourites
        queue :default
        max_attempts 3
      end
    end
  ...
  actions do
    ...
    action :cache_favourites, :integer do
      ...
      `PiFi.Plex.Sync.Favourites`.
      """

      run PiFi.Plex.Sync.Favourites
    end
  end
end

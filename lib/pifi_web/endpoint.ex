defmodule PiFiWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :pifi
  ...
  # policy of `PiFiWeb.Router` names `ws:` for the same reason, and it was the one

defmodule PiFiWeb.CinderTheme do
  @moduledoc """
  ...
  **The grid was the white card that this warned about.** `grid_item_class` of Cinder is
  ...
  `app.css` names `@source "../../lib/pifi_web"`, so a class in this module reaches
  ...
  # what the other three leave. See `PiFiWeb.ItemList.title_cell/1`.

defmodule MyHiFi.Playback.Item.Changes.ReleaseAudio do
  ...
  `MyHiFi.Player.release_file/1` when a person leaves a track that keeps no place. **A
  ...
  The `:destroy` and `:mark_played` actions of `MyHiFi.Playback.Item` both use this.

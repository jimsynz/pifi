defmodule MyHiFi.Playback.RemoveSourceCache do
  @moduledoc """
  ...
  **A job and not a task, because this device stops often.** It goes into standby, a
  ...
  `MyHiFi.Player` asks for this when a source goes out of use. See
  `MyHiFi.Playback.Item.RemoveCache` for what goes and what stays.
  """

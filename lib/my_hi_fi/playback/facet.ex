defmodule MyHiFi.Playback.Facet do
  ...
  **AshSqlite holds no aggregate of any kind.** `can?(_, {:aggregate, _type})` gives
  ...
  `MyHiFi.Playback.GroupedCount` is how `item_count` works, and it says why.
  """
  ...
  actions do
    ...
    action :destroy_orphans, :integer do
      ...
      run MyHiFi.Playback.Facet.DestroyOrphans
    end
  end
  ...
  relationships do
    ...
    many_to_many :items, MyHiFi.Playback.Item do

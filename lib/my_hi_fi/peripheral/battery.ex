defmodule MyHiFi.Peripheral.Battery do
  @moduledoc """
  ...
  **It asks the process and never the supervisor.** `MyHiFi.Peripheral.running?/1` reads
  ...
  `MyHiFi.AutoStandby` puts the device in standby there, `MyHiFi.Peripheral.ActivityLed`
  ...
  **The gauge reports more than 100 for a cell that is full and charging**, and it can
  ...
  other device, so this keeps it inside the range that they expect.
      ...
      iex> MyHiFi.Peripheral.Battery.percent(104.2)
      100

      iex> MyHiFi.Peripheral.Battery.percent(-0.5)
      0
  """

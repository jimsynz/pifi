...
if Mix.target() == :host do
  config :pifi,
         ...
         # the secret under `/root`. See `PiFi.DeviceSecrets`. The host keeps
         ...
         code_reloader: true,
         watchers: [
           esbuild: {Esbuild, :install_and_run, [:pifi, ["--sourcemap=inline", "--watch"]]},
           tailwind: {Tailwind, :install_and_run, [:pifi, ["--watch"]]}
         ],
         live_reload: [
